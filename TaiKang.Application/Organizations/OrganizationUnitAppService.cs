...
using TaiKang.Organizations.Dto;
using System.Linq.Dynamic;

namespace TaiKang.Organizations
{
    [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits)]
    public class OrganizationUnitAppService : TaiKangAppServiceBase, IOrganizationUnitAppService
    {
