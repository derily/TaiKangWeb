...
using TaiKang.Dto;
using TaiKang.Net.MimeTypes;
using OfficeOpenXml;

namespace TaiKang.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : TaiKangServiceBase, ITransientDependency
    {
