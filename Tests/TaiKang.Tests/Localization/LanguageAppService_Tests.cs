...
using TaiKang.Localization;
using TaiKang.Localization.Dto;
using TaiKang.Migrations.Seed.Host;
using Shouldly;
using Xunit;

namespace TaiKang.Tests.Localization
{
    public class LanguageAppService_Tests : AppTestBase
    {
        ...
        public async Task UpdateLanguageText()
        {
            await _languageAppService.UpdateLanguageText(
                ...
                {
                    SourceName = TaiKangConsts.LocalizationSourceName,
                    LanguageName = "en",
                    Key = "Save",
            ...
            var newValue = Resolve<ILocalizationManager>()
                .GetString(
                    TaiKangConsts.LocalizationSourceName,
                    "Save",
