...
namespace TaiKang.Migrations
{
    public partial class AbpZero_Role_SoftDelete : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.AbpRoles", "IsDefault", c => c.Boolean(nullable: false, defaultValue: false));
            AddColumn("dbo.AbpRoles", "IsDeleted", c => c.Boolean(nullable: false, defaultValue: false));
