namespace TaiKang.Migrations
{
    ...
    public partial class Module_Zero_v1_Improvements : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.AbpUsers", "IsPhoneNumberConfirmed", c => c.Boolean(nullable: false, defaultValue: false));
            AddColumn("dbo.AbpUsers", "SecurityStamp", c => c.String(defaultValueSql: "NEWID()"));
            AddColumn("dbo.AbpUsers", "IsTwoFactorEnabled", c => c.Boolean(nullable: false, defaultValue: true));

            Sql("UPDATE AbpUsers SET SecurityStamp = NEWID(), IsTwoFactorEnabled = 1, IsLockoutEnabled = 1");
        }
