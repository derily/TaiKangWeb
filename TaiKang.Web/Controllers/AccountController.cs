...
using TaiKang.Authorization.Impersonation;
...
using TaiKang.Web.Controllers.Results;
using TaiKang.Web.Models.Account;
using TaiKang.Web.MultiTenancy;
using Recaptcha.Web;
using Recaptcha.Web.Mvc;
using Newtonsoft.Json;
using TaiKang.Security;
using TaiKang.Web.Auth;
using TaiKang.Web.Models.Layout;

namespace TaiKang.Web.Controllers
{
    public class AccountController : TaiKangControllerBase
    {
