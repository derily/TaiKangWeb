...
using TaiKang.Configuration.Host;
using TaiKang.Editions;
using TaiKang.Timing;
using TaiKang.Timing.Dto;
using TaiKang.Web.Areas.Mpa.Models.HostSettings;
...
namespace TaiKang.Web.Areas.Mpa.Controllers
{
    ...
    public class HostSettingsController : TaiKangControllerBase
    {
