...
using TaiKang.Sessions;
using TaiKang.Web.Areas.Mpa.Models.Layout;
using TaiKang.Web.Areas.Mpa.Startup;
using TaiKang.Web.Controllers;
using TaiKang.Web.Models.Layout;
using TaiKang.Web.Session;
using HeaderViewModel = TaiKang.Web.Areas.Mpa.Models.Layout.HeaderViewModel;

namespace TaiKang.Web.Areas.Mpa.Controllers
{
    [AbpMvcAuthorize]
    public class LayoutController : TaiKangControllerBase
    {
