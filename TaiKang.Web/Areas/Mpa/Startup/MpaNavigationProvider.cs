...
using TaiKang.Web.Navigation;

namespace TaiKang.Web.Areas.Mpa.Startup
{
    public class MpaNavigationProvider : NavigationProvider
    {
        ...
        public override void SetNavigation(INavigationProviderContext context)
        {
            ...
            menu.AddItem(new MenuItemDefinition(
                        PageNames.App.Management.TaiKang,
                        L("TaiKang"),
                        icon: "icon-wrench"
                    ).AddItem(new MenuItemDefinition(
                            PageNames.App.Management.CompanyIntroduce,
                            L("TaiKang_CompanyIntroduce"),
                            url: "Mpa/CompanyIntroduce",
                            icon: ""
                        )
                    ).AddItem(new MenuItemDefinition(
                            PageNames.App.Management.BannerManager,
                            L("TaiKang_BannerManager"),
                            url: "Mpa/BannerManager",
                            icon: "",
                            requiredPermissionName: AppPermissions.Pages_TaiKang_BannerManager
                        )
                   ).AddItem(new MenuItemDefinition(
                            PageNames.App.Management.JobChance,
                            L("TaiKang_JobChance"),
                            url:"Mpa/Job",
                            icon:"",
