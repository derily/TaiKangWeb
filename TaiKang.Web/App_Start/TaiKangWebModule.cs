...
using TaiKang.Web.App.Startup;//SPA!
using TaiKang.Web.Areas.Mpa.Startup;//MPA!
using TaiKang.Web.Bundling;
using TaiKang.Web.Navigation;
using TaiKang.Web.Routing;
using TaiKang.WebApi;
using Swashbuckle.Application;
using System.Linq;

namespace TaiKang.Web
{
    /// <summary>
    ...
    [DependsOn(
        ...
        typeof(TaiKangDataModule),
        typeof(TaiKangApplicationModule),
        typeof(TaiKangWebApiModule),
    ...
    public class TaiKangWebModule : AbpModule
    {
        ...
        public override void PostInitialize()
        {
            ...
            appFolders.WebSiteImageFolder = server.MapPath("~/Common/SiteImages");
